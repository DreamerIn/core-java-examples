...
public class Java_RegEx {
   ...
   //we will write same code but without Pattern.CASE_INSENSITIVE parameter in Pattren.compile() method.
		Pattern pattern2 = Pattern.compile("w3schools");
		Matcher matcher21 = pattern2.matcher("Visit W3Schools!");
		boolean matchFound2 = matcher21.find();
		if(matchFound2) {
		      System.out.println("Match found");
		    } else {
		      System.out.println("Match not found");
